...
const insertSampleData = () => {
  ...
  const checkTasks = 'SELECT COUNT(*) AS count FROM tasks';
  connection.query(checkTasks, (err, results) => {
    if (err) {
  ...
  const checkUsers = 'SELECT COUNT(*) AS count FROM user';
  ...
  const checkTransactions = 'SELECT COUNT(*) AS count FROM transactions';
  connection.query(checkTransactions, (err, results) => {
    if (err) {
